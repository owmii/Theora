...
public class Liquid extends RegistryEntry<Liquid> {
    ...
    public static Liquid read(String key, CompoundNBT compound) {
        CompoundNBT nbt = compound.getCompound(key);
        return get(nbt.getString("LiquidId"));
    }

    public static Liquid read(CompoundNBT compound) {
        return get(compound.getString("LiquidId"));
    }

    public static void write(String key, Liquid liquid, CompoundNBT compound) {
    ...
    public static void write(Liquid liquid, CompoundNBT compound) {
