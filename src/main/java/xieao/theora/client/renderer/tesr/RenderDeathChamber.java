    ...
    public void render(TileDeathChamber te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (te.built) {
            ...
            if (!te.getStackInSlot(0).isEmpty()) {
                ...
                RenderUtil.renderItemStack(te.getStackInSlot(0), 0.7F);
                GlStateManager.popMatrix();
            }
            if (!te.getStackInSlot(1).isEmpty()) {
                ...
                RenderUtil.renderItemStack(te.getStackInSlot(1), 0.85F);
                GlStateManager.popMatrix();
            }
            if (!te.getStackInSlot(2).isEmpty()) {
                ...
                RenderUtil.renderItemStack(te.getStackInSlot(2), 0.85F);
                GlStateManager.popMatrix();
            }
            if (!te.getStackInSlot(3).isEmpty()) {
                ...
                RenderUtil.renderItemStack(te.getStackInSlot(3), 0.85F);
                GlStateManager.popMatrix();
            }
            if (!te.getStackInSlot(4).isEmpty()) {
                ...
                RenderUtil.renderItemStack(te.getStackInSlot(4), 0.85F);
                GlStateManager.popMatrix();
            }
        } else {
            GlStateManager.scale(1.0F, -1.0F, -1.0F);
